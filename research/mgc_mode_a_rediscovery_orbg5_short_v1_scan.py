#!/usr/bin/env python3
"""MGC Mode A rediscovery — ORB_G5 SHORT RR1.5 across 4 sessions (K=4).

Pre-registered at:
  docs/audit/hypotheses/2026-04-19-mgc-mode-a-rediscovery-orbg5-short-v1.yaml
  LOCKED at commit 4ac0b688.

Closes the short-direction audit gap left by the long sibling scan
(commit a8208674, family KILL). Symmetric session scope to long.
...
Output: docs/audit/results/2026-04-19-mgc-mode-a-rediscovery-orbg5-short-v1-scan.md
"""
...
RESULT_PATH = PROJECT_ROOT / "docs/audit/results/2026-04-19-mgc-mode-a-rediscovery-orbg5-short-v1-scan.md"
