...
Pre-registered at:
  docs/audit/hypotheses/2026-04-19-mes-broader-mode-a-rediscovery-v1.yaml
  LOCKED at commit 66964b74.
...
RESULT_PATH = PROJECT_ROOT / "docs/audit/results/2026-04-19-mes-broader-mode-a-rediscovery-v1-scan.md"
INSTRUMENT = "MES"
ORB_MINUTES = 5

CELLS = [
    {"id": "H1_CMX_PRE_ORB_G8_L_RR1",    "session": "CME_PRECLOSE", "rr": 1.0, "direction": "long",  "filter": "ORB_G8"},
    {"id": "H2_CMX_PRE_COST_LT12_L_RR1", "session": "CME_PRECLOSE", "rr": 1.0, "direction": "long",  "filter": "COST_LT12"},
    {"id": "H3_CMX_PRE_ATR_P70_L_RR1",   "session": "CME_PRECLOSE", "rr": 1.0, "direction": "long",  "filter": "ATR_P70"},
    {"id": "H4_USD1k_ORB_G5_S_RR15",     "session": "US_DATA_1000", "rr": 1.5, "direction": "short", "filter": "ORB_G5"},
    {"id": "H5_USD1k_ORB_G5_S_RR2",      "session": "US_DATA_1000", "rr": 2.0, "direction": "short", "filter": "ORB_G5"},
    {"id": "H6_USD1k_COST_LT12_S_RR15",  "session": "US_DATA_1000", "rr": 1.5, "direction": "short", "filter": "COST_LT12"},
]

PREREG_EXPR_ON = {
    "H1_CMX_PRE_ORB_G8_L_RR1": 0.280,
    "H2_CMX_PRE_COST_LT12_L_RR1": 0.156,
    "H3_CMX_PRE_ATR_P70_L_RR1": 0.142,
    "H4_USD1k_ORB_G5_S_RR15": 0.119,
    "H5_USD1k_ORB_G5_S_RR2": 0.146,
    "H6_USD1k_COST_LT12_S_RR15": 0.116,
}
K2_TOL = 0.005  # looser since baselines are approximate (pre-scan used float rounding)
...
def render(cells):
    ...
    L = []
    L.append("# MES broader Mode A rediscovery — K=6 scan")
    L.append("")
    L.append(f"**Generated:** {ts}")
    L.append(f"**Pre-reg:** `docs/audit/hypotheses/2026-04-19-mes-broader-mode-a-rediscovery-v1.yaml` LOCKED (commit 66964b74)")
    L.append(f"**Script:** `research/mes_broader_mode_a_rediscovery_v1_scan.py`")
