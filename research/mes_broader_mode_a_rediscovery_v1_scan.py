...
def analyze(con, cell):
    ...
    if r.fire_rate is not None:
        r.extreme_fire = r.fire_rate < 0.05 or r.fire_rate > 0.95
...
def render(cells):
    ...
    L.append(
        f"**Pre-reg:** `docs/audit/hypotheses/2026-04-19-mes-broader-mode-a-rediscovery-v1.yaml` LOCKED (commit 66964b74)"
    )
