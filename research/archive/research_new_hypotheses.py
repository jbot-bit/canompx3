...
for session in sessions_comp:
    ...
    for sym in SYMBOLS:
        ...
        for tier in ["compressed", "normal", "wide"]:
            k = (sym, tier)
            if k not in tiers or tiers[k]["n"] < MIN_N:
                continue
            d = tiers[k]
            wr = d["wins"] / d["n"]
...
for session in sessions_mom:
    ...
    for sym in SYMBOLS:
        ...
        with_mom = [r for r in sym_rows if (r[2] == "up" and r[3] == "long") or (r[2] == "down" and r[3] == "short")]
        against_mom = [r for r in sym_rows if (r[2] == "up" and r[3] == "short") or (r[2] == "down" and r[3] == "long")]
        baseline = sym_rows
        ...
        print(
            f"    with_mom:   n={n_m:4d}  WR={wr_m:.1%}  avgMFE={mfe_m:.2f}R  "
