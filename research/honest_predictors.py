...
run_test("0900 double-break -> 1100 outcome", "d.orb_0900_double_break", "AND d.orb_0900_double_break IS NOT NULL")

# 2. 1000 double-break (happens before 1100)
run_test("1000 double-break -> 1100 outcome", "d.orb_1000_double_break", "AND d.orb_1000_double_break IS NOT NULL")

# 3. 0900 outcome
run_test("0900 outcome -> 1100 outcome", "d.orb_0900_outcome", "AND d.orb_0900_outcome IS NOT NULL")

# 4. 1000 outcome
run_test("1000 outcome -> 1100 outcome", "d.orb_1000_outcome", "AND d.orb_1000_outcome IS NOT NULL")
...
# 7. ATR/ORB ratio
run_test(
    "ATR20 / 1100_ORB ratio -> 1100 outcome",
...
run_test(
    "BOTH 0900+1000 regime -> 1100 outcome",
...
run_test(
    "1100/0900 ORB size ratio -> 1100 outcome",
...
run_test(
    "Prior-day range/ATR -> 1100 outcome",
