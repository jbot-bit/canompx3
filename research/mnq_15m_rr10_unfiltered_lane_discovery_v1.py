"""MNQ 15m E2 CB1 RR=1.0 unfiltered lane discovery — Pathway B K=1x4.
...
PREREG_PATH = "docs/audit/hypotheses/2026-04-20-mnq-15m-rr10-unfiltered-lane-discovery-v1.yaml"
RESULT_DOC = Path("docs/audit/results/2026-04-20-mnq-15m-rr10-unfiltered-lane-discovery-v1.md")
...
CONFIRM_BARS = 1
RR_TARGET = 1.0
SESSIONS = ["CME_PRECLOSE", "NYSE_OPEN", "US_DATA_1000"]
...
def main() -> int:
    ...
    parts: list[str] = []
    parts.append("# MNQ 15m E2 CB1 RR=1.0 unfiltered lane discovery — v1\n")
    parts.append(f"**Pre-reg:** `{PREREG_PATH}`\n")
    parts.append(f"**Script:** `research/mnq_15m_rr10_unfiltered_lane_discovery_v1.py`\n")
