...
def main() -> int:
    ...
    parts.append("")
    parts.append(
        "`CONTINUE` for the bounded conditional-role follow-through. "
        "The measured daily-delta evidence supports further translation work, "
        "but this remains research-level evidence rather than a direct live-promotion decision."
    )
    parts.append("")
    ...
    parts.append("")
    parts.append("- Executable drag is a diagnostic overlay, not a separate promoted winner.")
    parts.append("- OOS remains a monitor, not a tuning surface.")
    parts.append("- This report does not create a native validation/allocation bridge by itself.")
    parts.append("")
