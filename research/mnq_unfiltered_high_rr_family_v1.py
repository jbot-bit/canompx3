"""MNQ unfiltered HIGH-RR cross-family scan — Pathway A with BH-FDR.

Pre-reg: docs/audit/hypotheses/2026-04-27-mnq-unfiltered-high-rr-family-v1.yaml

Extends the 2026-04-20 cross-family pre-reg's RR axis from {1.0, 1.5, 2.0}
to {1.0, 1.5, 2.0, 2.5, 3.0, 4.0} on MNQ × (5m, 15m) × all canonical
sessions × E2 CB1 unfiltered. Drops 30m (PR #49 found 30m RR=1.0 thin and
no current deployed lane uses 30m apertures).

K_family = 12 sessions × 2 apertures × 6 RRs = 144 (under Bailey 2013
MinBTL bound of N ≤ 300 for clean MNQ data).

BH-FDR at q=0.05 across the K=144 family. Chordia t ≥ +3.00 with theory
citation per Phase 0 Amendment 2.2. Downstream C5 (DSR), C6 (WFE), C8
(OOS), C9 (era stability) mandatory per pre_registered_criteria.md.
...
PREREG_PATH = "docs/audit/hypotheses/2026-04-27-mnq-unfiltered-high-rr-family-v1.yaml"
RESULT_DOC = Path("docs/audit/results/2026-04-27-mnq-unfiltered-high-rr-family-v1.md")
INSTRUMENT = "MNQ"
APERTURES = [5, 15]
