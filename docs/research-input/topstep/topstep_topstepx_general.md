...
WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
See the License for the specific language governing permissions and
limitations under the License. [Skip to main content](https://help.topstep.com/en/articles/14434175-topstepx#main-content)

# TopstepX™

Updated in the last hour

**[TopstepX Features](https://help.topstep.com/en/articles/14434175-topstepx#h_1eff2494c2)**

**[TopstepX Order Management](https://help.topstep.com/en/articles/14434175-topstepx#h_a3c384b323)**

**[TopstepX Risk Settings](https://help.topstep.com/en/articles/14434175-topstepx#h_a014f98a4f)**

**[Troubleshooting](https://help.topstep.com/en/articles/14434175-topstepx#h_96cf7fb06a)**
...
TopstepX™ is a trading platform designed to support Traders with tools for execution, risk management, and performance tracking. With features like advanced order management, customizable risk settings, and detailed performance insights, it helps Traders stay disciplined and refine their strategies. TopstepX offers flexible functionality to support Traders at every stage of their journey.
...
- Filled orders on the Lead account are mirrored on Follower accounts, but minor execution differences (slippage, liquidity, volatility, number of accounts) should be expected.
...
If you already have an open trade, you can adjust your risk and reward directly by dragging and dropping the bar that shows your P&L for that position.
...
TopstepX offers TradingView Charts, the most popular charting tool in the industry. You can have up to 8 charts open per screen, with positions, pending orders, profit/loss, size, and entry location all displayed directly on your charts. Charts load with the /ES product by default.
...
[What is the Scaling Plan?](https://help.topstep.com/en/articles/8284223-what-is-the-scaling-plan) [Why are my orders being rejected?](https://help.topstep.com/en/articles/8754027-why-are-my-orders-being-rejected) [What is Responsible Trading?](https://help.topstep.com/en/articles/10406542-what-is-responsible-trading) [TopstepX™ Daily Loss Limit](https://help.topstep.com/en/articles/10490293-topstepx-daily-loss-limit) [TopstepX™ API Access](https://help.topstep.com/en/articles/11187768-topstepx-api-access)
