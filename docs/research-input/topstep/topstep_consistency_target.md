...
WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
See the License for the specific language governing permissions and
limitations under the License. [Skip to main content](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#main-content)

# What is the Consistency Target?

Track your progress toward consistent, repeatable profits with Topstep's consistency objectives, which vary by account type and help ensure disciplined risk management across the Trading Combine and Express Funded Account.

Updated this week

Table of contents

[Consistency Objectives at Topstep](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_5ae6425b3c)[Consistency Target in the Trading Combine](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_9bab204372)[Express Funded Account Consistency](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_80abd64a32)[How the 40% Consistency Objective Works](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_159b8f4388)[How Is Express Funded Account Consistency Calculated?](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_08f86286fb)[Tracking Your Consistency](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_39b1ae09b6)[Does Consistency Reset After a Payout?](https://help.topstep.com/en/articles/8284208-what-is-the-consistency-target#h_4b96c37270)

* * *

# Consistency Objectives at Topstep
...
- [Consistency Target Calculator](https://drive.google.com/drive/folders/1QG3NoC9d3jfIS4oZcxhGBsNkEkJaMQ_6?usp=sharing)

- [Trading Combine Parameters](https://help.topstep.com/en/articles/8284197-trading-combine-parameters)

- [Express Funded Account Parameters](https://intercom.help/topstep-llc/en/articles/8284215-express-funded-account-parameters)
...
- Technically, no it isn't impossible -- but it _is_ unlikely. That's why we’ve built a **small buffer** into the backend that accounts for market fluctuations. This way, you don’t need to be down to the penny to pass! Keep those exits tight, and you'll be okay.
...
**We recommend never exceeding the _Best Day Recommendation_ in the table below to avoid a profit target increase.**
...
Losses and/or being in a drawdown do not affect the best day recommendation. If you don't want your profit target to increase, you cannot make more than the **Best Day Recommendation** numbers listed above, even if you have a losing day. In other words, if you are in a drawdown, the Consistency Target still applies.
...
You can use this free Excel spreadsheet calculator to help with Consistency Target calculations! [Download the Consistency Target Calculator here](https://drive.google.com/drive/folders/1QG3NoC9d3jfIS4oZcxhGBsNkEkJaMQ_6?usp=sharing)
...
The Consistency Target is never required; it's only an objective in the Trading Combine. The Consistency Target is **not a requirement for the Express Funded Account Standard or the Live Funded Account**.
...
Read more [here](https://help.topstep.com/en/articles/9823693-topstepx-personal-daily-profit-target?q=consistency), or watch this quick [video](https://www.youtube.com/watch?v=SN2LUO3lKnQ)!
...
[Topstep Program Overview](https://help.topstep.com/en/articles/8284099-topstep-program-overview) [Trading Combine® Parameters](https://help.topstep.com/en/articles/8284197-trading-combine-parameters) [Express Funded Account Parameters](https://help.topstep.com/en/articles/8284215-express-funded-account-parameters) [Live Funded Account Parameters](https://help.topstep.com/en/articles/10657969-live-funded-account-parameters)
