...
**Candidate:** `MNQ_EUROPE_FLOW_E2_RR1.5_CB1_ORB_G5`
...
|---|---|---|---|---|---|
| `ORB_G5` gate | `daily_features` / canonical filter registry | `daily_features.orb_EUROPE_FLOW_size` | `ORB_FORMATION` | CLEAR | `Phase A A4 marked ORB_G5 timing-valid for the live six-lane book.` |
| max_orb_size_pts overlay | prop_profiles + daily_features | `orb_EUROPE_FLOW_size` with cap `39` | ORB_FORMATION | CLEAR | Phase A snapshot 5e768af8 separated the execution overlay and measured the cap pass-rate for this lane. |
