...
- [x] This lane already shows `wf_tested=True` / `wf_passed=True` / `oos_exp_r=0.0922`
- Declared fresh-OOS start date: `UNAVAILABLE`

## Verdict

- [x] FAIL — `discovery_date=2026-04-13` with live OOS fields populated is not Mode-A holdout-clean.
