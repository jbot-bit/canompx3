...
**Prereq file:** `docs\audit\hypotheses\2026-05-21-mnq-comexsettle-atrp50-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-21-mnq-comexsettle-atrp50-chordia-unlock-v1.csv`
...
IS clears strict threshold 3.79 with N=837 and ExpR=0.1451; OOS sign matches at N_OOS=60.
...
| OOS | 78 | 60 | 76.92% | 1 | 0 | 0.1594 | 0.1226 | 0.1715 | 1.329 | 0.18392 |
...
| OOS | 31 | 0.0128 | 0.075 | 29 | 0.3161 | 1.894 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-21-mnq-comexsettle-atrp50-chordia-unlock-v1.yaml
```
