# Chordia strict unlock audit — MNQ_US_DATA_1000_E2_RR1.0_CB1_PD_GO_LONG

**Prereq file:** `docs/audit/hypotheses/2026-05-10-mnq-usdata1000-pdgolong-rr10-chordia-unlock-v1.yaml`
**Result CSV:** `docs/audit/results/2026-05-10-mnq-usdata1000-pdgolong-rr10-chordia-unlock-v1.csv`
**Canonical DB:** `/mnt/c/Users/joshd/canompx3/gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_US_DATA_1000_E2_RR1.0_CB1_PD_GO_LONG`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.

## Verdict

**MEASURED verdict:** `PASS_CHORDIA_OOS_UNDERPOWERED`

IS clears strict threshold 3.79; OOS N=19 < 30.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1547 | 330 | 21.33% | 6 | 0 | 0.1949 | 0.0416 | 0.2113 | 3.839 | 0.00012 |
| OOS | 77 | 19 | 24.68% | 1 | 0 | 0.2800 | 0.0691 | 0.3040 | 1.325 | 0.18507 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 330 | 0.1949 | 3.839 | 0 | nan | nan |
| OOS | 19 | 0.2800 | 1.325 | 0 | nan | nan |
...
- Canonical filter delegation: `filter_signal(..., 'PD_GO_LONG', 'US_DATA_1000')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs/audit/hypotheses/2026-05-10-mnq-usdata1000-pdgolong-rr10-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs/audit/results/2026-05-10-mnq-usdata1000-pdgolong-rr10-chordia-unlock-v1.md`
- `docs/audit/results/2026-05-10-mnq-usdata1000-pdgolong-rr10-chordia-unlock-v1.csv`
