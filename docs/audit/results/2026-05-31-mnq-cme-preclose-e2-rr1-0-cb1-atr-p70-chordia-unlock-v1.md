# Chordia strict unlock audit — MNQ_CME_PRECLOSE_E2_RR1.0_CB1_ATR_P70

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-chordia-unlock-v1.csv`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1479 | 570 | 38.54% | 58 | 0 | 0.1690 | 0.0651 | 0.1939 | 4.628 | 0.00000 |
| OOS | 83 | 47 | 56.63% | 1 | 0 | -0.0223 | -0.0126 | -0.0235 | -0.161 | 0.87213 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 284 | 0.2574 | 5.142 | 286 | 0.0813 | 1.542 |
| OOS | 24 | 0.1243 | 0.653 | 23 | -0.1752 | -0.874 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-chordia-unlock-v1.csv`
