# Chordia strict unlock audit — MNQ_EUROPE_FLOW_E2_RR2.0_CB1_PDR_R105

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-europe-flow-e2-rr2-0-cb1-pdr-r105-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-europe-flow-e2-rr2-0-cb1-pdr-r105-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_EUROPE_FLOW_E2_RR2.0_CB1_PDR_R105`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1547 | 623 | 40.27% | 0 | 0 | 0.1815 | 0.0731 | 0.1339 | 3.343 | 0.00083 |
| OOS | 87 | 31 | 35.63% | 0 | 0 | 0.1685 | 0.0600 | 0.1204 | 0.671 | 0.50249 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 318 | 0.1813 | 2.372 | 305 | 0.1817 | 2.352 |
| OOS | 17 | 0.1587 | 0.458 | 14 | 0.1803 | 0.477 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-europe-flow-e2-rr2-0-cb1-pdr-r105-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-europe-flow-e2-rr2-0-cb1-pdr-r105-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-europe-flow-e2-rr2-0-cb1-pdr-r105-chordia-unlock-v1.csv`
