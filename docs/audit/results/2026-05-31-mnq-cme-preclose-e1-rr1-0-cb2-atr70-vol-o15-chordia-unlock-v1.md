# Chordia strict unlock audit — MNQ_CME_PRECLOSE_E1_RR1.0_CB2_ATR70_VOL_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e1-rr1-0-cb2-atr70-vol-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-cme-preclose-e1-rr1-0-cb2-atr70-vol-o15-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_CME_PRECLOSE_E1_RR1.0_CB2_ATR70_VOL_O15`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1001 | 265 | 26.47% | 212 | 16 | 0.0615 | 0.0163 | 0.1326 | 2.158 | 0.03092 |
| OOS | 64 | 19 | 29.69% | 11 | 4 | 0.0925 | 0.0275 | 0.1711 | 0.746 | 0.45570 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 126 | 0.0833 | 1.958 | 139 | 0.0418 | 1.089 |
| OOS | 7 | 0.3153 | 1.451 | 12 | -0.0375 | -0.261 |
...
- Canonical filter delegation: `filter_signal(..., 'ATR70_VOL', 'CME_PRECLOSE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e1-rr1-0-cb2-atr70-vol-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-cme-preclose-e1-rr1-0-cb2-atr70-vol-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-cme-preclose-e1-rr1-0-cb2-atr70-vol-o15-chordia-unlock-v1.csv`
