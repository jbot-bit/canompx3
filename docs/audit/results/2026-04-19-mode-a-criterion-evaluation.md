...
**Generated:** 2026-04-19T09:25:53+00:00
...
**Criteria source:** `docs/institutional/pre_registered_criteria.md` § Criteria 4, 7, 9 (LOCKED thresholds)
...
### Pre-registered criterion failures under Mode A (this is the NEW signal)

- Lanes failing Criterion 4 at the WITH-THEORY bar (t >= 3.0): **29**
- Lanes failing Criterion 4 at the NO-THEORY bar (t >= 3.79): **34**
  — BOTH counts reported because `pre_registered_criteria.md` § Criterion 4
  requires per-lane theory-citation evidence before the softer 3.00 bar applies;
  this report does NOT verify per-lane theory citations. Downstream committee
  must confirm theory grounding before citing the with-theory count as binding.
- Lanes failing Criterion 7 (Mode A N >= 100): **1**
- Lanes failing Criterion 9 (no doctrine era with N>=50 & ExpR<-0.05): **7**
  — Eras per doctrine: ['2015-2019', '2020-2022', '2023', '2024-2025', '2026']
- Lanes failing AT LEAST ONE of {C4_with_theory, C7, C9} under Mode A: **30**

Failing one or more of C4/C7/C9 under Mode A means the lane is not
deployment-eligible under the locked doctrine without either (a) explicit
documented theory citation + promotion of the 3.00 with-theory grounding
to DIRECT (per pre_registered_criteria.md § Criterion 4), OR (b) re-validation
on a larger population, OR (c) explicit regime-gating to exclude the weak era.

## Thresholds

- N ratio: |ΔN / stored_N| > 0.1 → drift flag
- ExpR absolute: |ΔExpR| > 0.03 → drift flag
- Sharpe absolute: |ΔSharpe_ann| > 0.2 → drift flag
- Mode-B contaminated: `last_trade_day >= 2026-01-01` → drift flag
- Criterion 4: t_IS >= 3.0 (with-theory) or >= 3.79 (no-theory)
- Criterion 7: N_ModeA >= 100
- Criterion 9: no era with N >= 50 and ExpR < -0.05

**Note on Criterion 4 grounding:** `pre_registered_criteria.md` § Criterion 4
flags the 3.0 with-theory threshold as currently INDIRECT Tier 1
(via Chordia et al 2018 p5 referencing Harvey-Liu-Zhu 2015). The doc requires
promotion to DIRECT before any 3.00 ≤ t < 3.79 with-theory candidate is
accepted. Lanes with t in [3.0, 3.79) are flagged
below as `c4_with_theory_PASS` / `c4_no_theory_FAIL` so the caveat is explicit.

### How to read this doc (signal vs tripwire)

**Material-drift flag = INFORMATIONAL TRIPWIRE, not retirement signal.**
Thresholds (10% N / 0.03 ExpR / 0.20 Sharpe / Mode-B grandfather) are
engineering tolerances, NOT literature-grounded — they detect any
Mode-A-vs-stored divergence so downstream readers know stored values are
partially computed on a different IS window. Under Amendment 2.7
(Mode B → Mode A, 2026-04-08), stored `validated_setups` values pre-date
the sacred-holdout boundary and will ALWAYS flag material drift on
recompute — so a 38/38 drift count is EXPECTED, not alarming.

**Retirement-relevant signal = Criterion 4, 7, 9 pass/fail columns below.**
Those thresholds ARE locked in `pre_registered_criteria.md` — those
failures are doctrine-grounded and actionable. A lane failing one or
more of {C4_with_theory, C7, C9} under Mode A is not deployment-eligible
under the locked doctrine without explicit re-validation, theory-citation
promotion, or regime-gating.

Treat the Mode A column as the canonical truth going forward; the
validated_setups rows themselves are NOT mutated by this audit.

## Per-lane re-validation + criterion evaluation

Columns: `t_IS` = Chordia t-stat from Mode A (ExpR/(sd/√N)); `C4_wth` = pass with-theory (t≥3.00); `C4_nth` = pass no-theory (t≥3.79); `C7` = N≥100; `C9` = era stability (no year ExpR<-0.05 with N≥50).

| Instr | Session | Om | RR | Filter | Dir | Stored N / Mode-A N | ΔN/N | Stored ExpR / Mode-A ExpR | ΔExpR | Stored Sh / Mode-A Sh | ΔSh | Yrs+ | Mode-B | t_IS | C4_wth | C4_nth | C7 | C9 | Drift | Crit Fails |
|---|---|---:|---:|---|---|---|---:|---|---:|---|---:|---:|---|---:|---|---|---|---|---|---|
| MES | CME_PRECLOSE | 5 | 1.0 | COST_LT08 | long | 194 / 88 | -0.55 | 0.1962 / 0.3279 | 0.1317 | 1.25 / 1.45 | 0.20 | 3/3 | N | 3.56 | PASS | FAIL | FAIL | PASS | DRIFT | C7 N=88 < 100 |
| MES | CME_PRECLOSE | 5 | 1.0 | ORB_G8 | long | 287 / 130 | -0.55 | 0.1729 / 0.2798 | 0.1069 | 1.34 / 1.49 | 0.15 | 4/5 | N | 3.66 | PASS | FAIL | PASS | PASS | DRIFT |  |
| MNQ | CME_PRECLOSE | 5 | 1.0 | X_MES_ATR60 | long | 596 / 306 | -0.49 | 0.1702 / 0.2140 | 0.0438 | 1.88 / 1.58 | -0.30 | 6/7 | N | 4.19 | PASS | PASS | PASS | PASS | DRIFT |  |
| MNQ | COMEX_SETTLE | 5 | 1.0 | COST_LT12 | long | 1247 / 669 | -0.46 | 0.1104 / 0.1041 | -0.0063 | 1.74 / 1.11 | -0.63 | 6/7 | N | 2.94 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.94 < 3.0 (with-theory) |
| MNQ | COMEX_SETTLE | 5 | 1.0 | ORB_G5 | long | 1473 / 836 | -0.43 | 0.0890 / 0.0780 | -0.0110 | 1.54 / 0.95 | -0.59 | 5/7 | N | 2.50 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.50 < 3.0 (with-theory) |
| MNQ | COMEX_SETTLE | 5 | 1.0 | OVNRNG_100 | long | 520 / 283 | -0.46 | 0.1725 / 0.1844 | 0.0119 | 1.76 / 1.29 | -0.47 | 5/5 | N | 3.42 | PASS | FAIL | PASS | PASS | DRIFT |  |
| MNQ | COMEX_SETTLE | 5 | 1.0 | X_MES_ATR60 | long | 673 / 385 | -0.43 | 0.1512 / 0.1950 | 0.0438 | 1.78 / 1.62 | -0.16 | 7/7 | N | 4.29 | PASS | PASS | PASS | PASS | DRIFT |  |
| MNQ | COMEX_SETTLE | 5 | 1.5 | ORB_G5 | long | 1459 / 829 | -0.43 | 0.1119 / 0.0922 | -0.0197 | 1.52 / 0.88 | -0.64 | 5/7 | N | 2.32 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=2.32 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | COMEX_SETTLE | 5 | 1.5 | OVNRNG_100 | long | 513 / 278 | -0.46 | 0.2151 / 0.1868 | -0.0283 | 1.70 / 1.00 | -0.69 | 5/5 | N | 2.65 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.65 < 3.0 (with-theory) |
| MNQ | COMEX_SETTLE | 5 | 1.5 | X_MES_ATR60 | long | 664 / 379 | -0.43 | 0.1609 / 0.1981 | 0.0372 | 1.46 / 1.26 | -0.21 | 5/7 | N | 3.32 | PASS | FAIL | PASS | PASS | DRIFT |  |
| MNQ | COMEX_SETTLE | 5 | 2.0 | ORB_G5 | long | 1443 / 814 | -0.44 | 0.0890 / 0.1059 | 0.0169 | 1.02 / 0.85 | -0.18 | 5/7 | N | 2.24 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=2.24 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | EUROPE_FLOW | 5 | 1.0 | COST_LT12 | long | 1024 / 521 | -0.49 | 0.0921 / 0.0540 | -0.0381 | 1.32 / 0.51 | -0.82 | 6/7 | N | 1.34 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.34 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 1.0 | CROSS_SGP_MOMENTUM | long | 1020 / 535 | -0.48 | 0.0850 / 0.0502 | -0.0348 | 1.18 / 0.50 | -0.67 | 5/7 | Y | 1.34 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=1.34 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | EUROPE_FLOW | 5 | 1.0 | ORB_G5 | long | 1485 / 773 | -0.48 | 0.0655 / 0.0353 | -0.0302 | 1.16 / 0.42 | -0.74 | 6/7 | N | 1.10 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=1.10 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | EUROPE_FLOW | 5 | 1.0 | OVNRNG_100 | long | 532 / 263 | -0.51 | 0.1179 / 0.0560 | -0.0619 | 1.22 / 0.37 | -0.85 | 4/6 | N | 0.99 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=0.99 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 1.5 | COST_LT12 | long | 1024 / 521 | -0.49 | 0.1067 / 0.1049 | -0.0018 | 1.21 / 0.78 | -0.42 | 7/7 | N | 2.07 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.07 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 1.5 | CROSS_SGP_MOMENTUM | long | 1020 / 535 | -0.48 | 0.0936 / 0.0812 | -0.0124 | 1.01 / 0.64 | -0.37 | 5/7 | Y | 1.70 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.70 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 1.5 | ORB_G5 | long | 1485 / 773 | -0.48 | 0.0740 / 0.0769 | 0.0029 | 1.03 / 0.72 | -0.31 | 6/7 | N | 1.90 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.90 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 1.5 | OVNRNG_100 | long | 532 / 263 | -0.51 | 0.1714 / 0.1180 | -0.0534 | 1.39 / 0.62 | -0.77 | 6/6 | N | 1.65 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.65 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 2.0 | CROSS_SGP_MOMENTUM | long | 1020 / 535 | -0.48 | 0.1229 / 0.1122 | -0.0107 | 1.12 / 0.75 | -0.38 | 6/7 | Y | 1.98 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.98 < 3.0 (with-theory) |
| MNQ | EUROPE_FLOW | 5 | 2.0 | ORB_G5 | long | 1485 / 773 | -0.48 | 0.0961 / 0.0735 | -0.0226 | 1.14 / 0.58 | -0.55 | 4/7 | N | 1.54 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.54 < 3.0 (with-theory) |
| MNQ | NYSE_OPEN | 5 | 1.0 | COST_LT12 | long | 1508 / 844 | -0.44 | 0.0870 / 0.0694 | -0.0176 | 1.43 / 0.79 | -0.64 | 7/7 | N | 2.10 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.10 < 3.0 (with-theory) |
| MNQ | NYSE_OPEN | 5 | 1.0 | ORB_G5 | long | 1521 / 856 | -0.44 | 0.0889 / 0.0664 | -0.0225 | 1.47 / 0.77 | -0.71 | 6/7 | N | 2.03 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.03 < 3.0 (with-theory) |
| MNQ | NYSE_OPEN | 5 | 1.0 | X_MES_ATR60 | long | 689 / 345 | -0.50 | 0.1365 / 0.0784 | -0.0581 | 1.54 / 0.57 | -0.97 | 5/7 | N | 1.51 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.51 < 3.0 (with-theory) |
| MNQ | NYSE_OPEN | 5 | 1.5 | COST_LT12 | long | 1472 / 817 | -0.44 | 0.1050 / 0.0887 | -0.0163 | 1.36 / 0.80 | -0.57 | 6/7 | N | 2.11 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=2.11 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | NYSE_OPEN | 5 | 1.5 | ORB_G5 | long | 1485 / 829 | -0.44 | 0.1067 / 0.0858 | -0.0209 | 1.39 / 0.78 | -0.61 | 5/7 | N | 2.06 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=2.06 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50) |
| MNQ | NYSE_OPEN | 5 | 1.5 | X_MES_ATR60 | long | 673 / 334 | -0.50 | 0.1323 / 0.0656 | -0.0667 | 1.17 / 0.38 | -0.79 | 5/7 | N | 1.00 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.00 < 3.0 (with-theory) |
| MNQ | SINGAPORE_OPEN | 15 | 1.5 | ATR_P50 | long | 968 / 496 | -0.49 | 0.1087 / 0.2046 | 0.0959 | 1.14 / 1.50 | 0.36 | 6/7 | Y | 3.96 | PASS | PASS | PASS | PASS | DRIFT |  |
| MNQ | SINGAPORE_OPEN | 30 | 1.5 | ATR_P50 | long | 961 / 485 | -0.50 | 0.1251 / 0.2210 | 0.0959 | 1.28 / 1.56 | 0.29 | 6/7 | Y | 4.14 | PASS | PASS | PASS | PASS | DRIFT |  |
| MNQ | TOKYO_OPEN | 5 | 1.0 | COST_LT12 | long | 918 / 469 | -0.49 | 0.0959 / 0.0786 | -0.0173 | 1.31 / 0.71 | -0.60 | 6/7 | N | 1.87 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.87 < 3.0 (with-theory) |
| MNQ | TOKYO_OPEN | 5 | 1.5 | COST_LT12 | long | 918 / 469 | -0.49 | 0.1293 / 0.1036 | -0.0257 | 1.39 / 0.74 | -0.65 | 6/7 | N | 1.95 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.95 < 3.0 (with-theory) |
| MNQ | TOKYO_OPEN | 5 | 1.5 | ORB_G5 | long | 1487 / 786 | -0.47 | 0.0945 / 0.0992 | 0.0047 | 1.33 / 0.95 | -0.39 | 6/7 | N | 2.50 | FAIL | FAIL | PASS | FAIL | DRIFT | C4 t=2.50 < 3.0 (with-theory); C9 era(s) ['2023'] ExpR<-0.05 (era-N>=50) |
| MNQ | TOKYO_OPEN | 5 | 2.0 | ORB_G5 | long | 1487 / 785 | -0.47 | 0.0866 / 0.1233 | 0.0367 | 1.04 / 0.99 | -0.05 | 5/7 | N | 2.62 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.62 < 3.0 (with-theory) |
| MNQ | US_DATA_1000 | 5 | 1.0 | X_MES_ATR60 | long | 694 / 371 | -0.47 | 0.0996 / 0.0770 | -0.0226 | 1.14 / 0.59 | -0.55 | 5/7 | N | 1.56 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.56 < 3.0 (with-theory) |
| MNQ | US_DATA_1000 | 15 | 1.0 | VWAP_MID_ALIGNED | long | 744 / 460 | -0.38 | 0.1492 / 0.1323 | -0.0169 | 1.74 / 1.13 | -0.61 | 5/7 | Y | 2.99 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.99 < 3.0 (with-theory) |
| MNQ | US_DATA_1000 | 15 | 1.5 | ORB_G5 | long | 1348 / 800 | -0.41 | 0.0930 / 0.0565 | -0.0365 | 1.16 / 0.51 | -0.65 | 6/7 | Y | 1.34 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=1.34 < 3.0 (with-theory) |
| MNQ | US_DATA_1000 | 15 | 1.5 | VWAP_MID_ALIGNED | long | 701 / 436 | -0.38 | 0.2101 / 0.1844 | -0.0257 | 1.87 / 1.21 | -0.66 | 6/7 | Y | 3.20 | PASS | FAIL | PASS | PASS | DRIFT |  |
| MNQ | US_DATA_1000 | 15 | 2.0 | VWAP_MID_ALIGNED | long | 635 / 398 | -0.37 | 0.1757 / 0.1481 | -0.0276 | 1.27 / 0.79 | -0.47 | 5/7 | Y | 2.09 | FAIL | FAIL | PASS | PASS | DRIFT | C4 t=2.09 < 3.0 (with-theory) |

## Criterion-failing lanes — prioritised view
...
- Criterion failures under Mode A: C7 N=88 < 100
...
- Criterion failures under Mode A: C4 t=1.10 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.105(N=51)
...
- Criterion failures under Mode A: C4 t=1.34 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.062(N=52)
...
- Criterion failures under Mode A: C4 t=2.06 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.059(N=86)
...
- Criterion failures under Mode A: C4 t=2.11 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.053(N=81)
...
- Criterion failures under Mode A: C4 t=2.24 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.267(N=52)
...
- Criterion failures under Mode A: C4 t=2.32 < 3.0 (with-theory); C9 era(s) ['2015-2019'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2015-2019:-0.136(N=57)
...
- Criterion failures under Mode A: C4 t=2.50 < 3.0 (with-theory); C9 era(s) ['2023'] ExpR<-0.05 (era-N>=50)
- Violating eras (aggregate): 2023:-0.094(N=113)
...
- Criterion failures under Mode A: C4 t=0.99 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.00 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.34 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.51 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.54 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.56 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.65 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.70 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.87 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.90 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.95 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=1.98 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.03 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.07 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.09 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.10 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.50 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.62 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.65 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.94 < 3.0 (with-theory)
...
- Criterion failures under Mode A: C4 t=2.99 < 3.0 (with-theory)
