...
**Prereq file:** `docs/audit/hypotheses/2026-05-10-mnq-nyseopen-xmesatr60-rr10-chordia-unlock-v1.yaml`
**Result CSV:** `docs/audit/results/2026-05-10-mnq-nyseopen-xmesatr60-rr10-chordia-unlock-v1.csv`
...
| OOS | 78 | 50 | 64.10% | 0 | 0 | 0.2592 | 0.1662 | 0.2717 | 1.921 | 0.05470 |
...
| OOS | 23 | 0.1999 | 0.974 | 27 | 0.3098 | 1.705 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs/audit/hypotheses/2026-05-10-mnq-nyseopen-xmesatr60-rr10-chordia-unlock-v1.yaml
```
