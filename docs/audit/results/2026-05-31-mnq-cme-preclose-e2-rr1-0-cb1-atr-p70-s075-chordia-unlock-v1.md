# Chordia strict unlock audit — MNQ_CME_PRECLOSE_E2_RR1.0_CB1_ATR_P70_S075

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-s075-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-s075-chordia-unlock-v1.csv`
...
IS clears strict threshold 3.79 with N=570 and ExpR=0.1586; OOS sign matches at N_OOS=47.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1479 | 570 | 38.54% | 36 | 0 | 0.1586 | 0.0611 | 0.2006 | 4.790 | 0.00000 |
| OOS | 83 | 47 | 56.63% | 1 | 0 | 0.0597 | 0.0338 | 0.0723 | 0.495 | 0.62035 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 284 | 0.2316 | 5.021 | 286 | 0.0861 | 1.824 |
| OOS | 24 | 0.2181 | 1.311 | 23 | -0.1056 | -0.616 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-s075-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-s075-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-atr-p70-s075-chordia-unlock-v1.csv`
