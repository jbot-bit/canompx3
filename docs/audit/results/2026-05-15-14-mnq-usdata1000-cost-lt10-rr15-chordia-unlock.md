# Chordia strict unlock audit — MNQ_US_DATA_1000_E2_RR1.5_CB1_COST_LT10

**Prereq file:** `docs\audit\hypotheses\2026-05-15-14-mnq-usdata1000-cost-lt10-rr15-chordia-unlock.yaml`
**Result CSV:** `docs\audit\results\2026-05-15-14-mnq-usdata1000-cost-lt10-rr15-chordia-unlock.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_US_DATA_1000_E2_RR1.5_CB1_COST_LT10`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1547 | 1487 | 96.12% | 35 | 0 | 0.1106 | 0.1063 | 0.0935 | 3.604 | 0.00031 |
...
|---|---:|---:|---:|---:|---:|---:|
| IS | 786 | 0.0700 | 1.667 | 701 | 0.1562 | 3.474 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-15-14-mnq-usdata1000-cost-lt10-rr15-chordia-unlock.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-15-14-mnq-usdata1000-cost-lt10-rr15-chordia-unlock.md`
- `docs\audit\results\2026-05-15-14-mnq-usdata1000-cost-lt10-rr15-chordia-unlock.csv`
