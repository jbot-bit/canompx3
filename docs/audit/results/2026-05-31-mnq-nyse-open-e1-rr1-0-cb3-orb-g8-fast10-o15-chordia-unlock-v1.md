# Chordia strict unlock audit — MNQ_NYSE_OPEN_E1_RR1.0_CB3_ORB_G8_FAST10_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-orb-g8-fast10-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-orb-g8-fast10-o15-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_NYSE_OPEN_E1_RR1.0_CB3_ORB_G8_FAST10_O15`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1545 | 1015 | 65.70% | 145 | 60 | 0.0629 | 0.0413 | 0.0708 | 2.257 | 0.02400 |
...
|---|---:|---:|---:|---:|---:|---:|
| IS | 502 | 0.1237 | 3.052 | 513 | 0.0034 | 0.088 |
...
- Canonical filter delegation: `filter_signal(..., 'ORB_G8_FAST10', 'NYSE_OPEN')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-orb-g8-fast10-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-orb-g8-fast10-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-orb-g8-fast10-o15-chordia-unlock-v1.csv`
