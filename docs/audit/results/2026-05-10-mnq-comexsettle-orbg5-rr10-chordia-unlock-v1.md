...
**Prereq file:** `docs/audit/hypotheses/2026-05-10-mnq-comexsettle-orbg5-rr10-chordia-unlock-v1.yaml`
**Result CSV:** `docs/audit/results/2026-05-10-mnq-comexsettle-orbg5-rr10-chordia-unlock-v1.csv`
...
IS clears strict threshold 3.79 with N=1478 and ExpR=0.0895; OOS sign matches at N_OOS=75.
...
| OOS | 75 | 75 | 100.00% | 1 | 0 | 0.1029 | 0.1029 | 0.1097 | 0.950 | 0.34215 |
...
| OOS | 39 | 0.0954 | 0.637 | 36 | 0.1109 | 0.699 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs/audit/hypotheses/2026-05-10-mnq-comexsettle-orbg5-rr10-chordia-unlock-v1.yaml
```
