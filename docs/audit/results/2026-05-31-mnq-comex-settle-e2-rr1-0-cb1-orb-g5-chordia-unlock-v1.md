# Chordia strict unlock audit — MNQ_COMEX_SETTLE_E2_RR1.0_CB1_ORB_G5

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-comex-settle-e2-rr1-0-cb1-orb-g5-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr1-0-cb1-orb-g5-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_ORB_G5`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.

## Verdict

**MEASURED verdict:** `PASS_CHORDIA`

IS clears strict threshold 3.79 with N=1478 and ExpR=0.0895; OOS sign matches at N_OOS=84.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1494 | 1478 | 98.93% | 5 | 0 | 0.0895 | 0.0885 | 0.0989 | 3.802 | 0.00014 |
| OOS | 84 | 84 | 100.00% | 1 | 0 | 0.1222 | 0.1222 | 0.1306 | 1.197 | 0.23146 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 781 | 0.0844 | 2.606 | 697 | 0.0953 | 2.776 |
| OOS | 43 | 0.1721 | 1.223 | 41 | 0.0700 | 0.467 |
...
- Canonical filter delegation: `filter_signal(..., 'ORB_G5', 'COMEX_SETTLE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-comex-settle-e2-rr1-0-cb1-orb-g5-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr1-0-cb1-orb-g5-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr1-0-cb1-orb-g5-chordia-unlock-v1.csv`
