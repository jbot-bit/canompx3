# Chordia strict unlock audit — MNQ_NYSE_CLOSE_E2_RR1.0_CB1_ORB_VOL_8K_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-orb-vol-8k-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-orb-vol-8k-o15-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_NYSE_CLOSE_E2_RR1.0_CB1_ORB_VOL_8K_O15`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 865 | 654 | 75.61% | 440 | 0 | 0.0240 | 0.0182 | 0.0398 | 1.019 | 0.30821 |
...
|---|---:|---:|---:|---:|---:|---:|
| IS | 354 | 0.0597 | 1.987 | 300 | -0.0181 | -0.487 |
...
- Canonical filter delegation: `filter_signal(..., 'ORB_VOL_8K', 'NYSE_CLOSE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-orb-vol-8k-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-orb-vol-8k-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-orb-vol-8k-o15-chordia-unlock-v1.csv`
