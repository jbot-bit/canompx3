# Chordia strict unlock audit — MNQ_TOKYO_OPEN_E2_RR1.0_CB1_ATR_VEL_GE105_S075

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-tokyo-open-e2-rr1-0-cb1-atr-vel-ge105-s075-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-tokyo-open-e2-rr1-0-cb1-atr-vel-ge105-s075-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_TOKYO_OPEN_E2_RR1.0_CB1_ATR_VEL_GE105_S075`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.

## Verdict

**MEASURED verdict:** `PASS_CHORDIA_OOS_UNDERPOWERED`

IS clears strict threshold 3.79; OOS N=15 < 30.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1551 | 339 | 21.86% | 0 | 0 | 0.1725 | 0.0377 | 0.2231 | 4.108 | 0.00004 |
| OOS | 88 | 15 | 17.05% | 0 | 0 | 0.2187 | 0.0373 | 0.2659 | 1.030 | 0.30303 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 161 | 0.1875 | 3.102 | 178 | 0.1590 | 2.717 |
| OOS | 9 | 0.3243 | 1.198 | 6 | 0.0604 | 0.167 |
...
- Canonical filter delegation: `filter_signal(..., 'ATR_VEL_GE105', 'TOKYO_OPEN')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-tokyo-open-e2-rr1-0-cb1-atr-vel-ge105-s075-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-tokyo-open-e2-rr1-0-cb1-atr-vel-ge105-s075-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-tokyo-open-e2-rr1-0-cb1-atr-vel-ge105-s075-chordia-unlock-v1.csv`
