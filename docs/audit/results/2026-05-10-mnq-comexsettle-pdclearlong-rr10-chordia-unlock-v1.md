# Chordia strict unlock audit — MNQ_COMEX_SETTLE_E2_RR1.0_CB1_PD_CLEAR_LONG

**Prereq file:** `docs/audit/hypotheses/2026-05-10-mnq-comexsettle-pdclearlong-rr10-chordia-unlock-v1.yaml`
**Result CSV:** `docs/audit/results/2026-05-10-mnq-comexsettle-pdclearlong-rr10-chordia-unlock-v1.csv`
**Canonical DB:** `/mnt/c/Users/joshd/canompx3/gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_PD_CLEAR_LONG`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1494 | 303 | 20.28% | 0 | 0 | 0.1841 | 0.0373 | 0.2094 | 3.646 | 0.00027 |
| OOS | 75 | 19 | 25.33% | 0 | 0 | 0.2931 | 0.0743 | 0.3241 | 1.413 | 0.15775 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 303 | 0.1841 | 3.646 | 0 | nan | nan |
| OOS | 19 | 0.2931 | 1.413 | 0 | nan | nan |
...
- Canonical filter delegation: `filter_signal(..., 'PD_CLEAR_LONG', 'COMEX_SETTLE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs/audit/hypotheses/2026-05-10-mnq-comexsettle-pdclearlong-rr10-chordia-unlock-v1.yaml
```
