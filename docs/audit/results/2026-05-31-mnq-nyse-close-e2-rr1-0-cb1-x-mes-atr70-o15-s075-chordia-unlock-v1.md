# Chordia strict unlock audit — MNQ_NYSE_CLOSE_E2_RR1.0_CB1_X_MES_ATR70_O15_S075

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-x-mes-atr70-o15-s075-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-x-mes-atr70-o15-s075-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_NYSE_CLOSE_E2_RR1.0_CB1_X_MES_ATR70_O15_S075`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 865 | 304 | 35.14% | 186 | 0 | 0.0799 | 0.0281 | 0.1394 | 2.430 | 0.01510 |
| OOS | 57 | 31 | 54.39% | 18 | 0 | 0.3256 | 0.1771 | 0.5881 | 3.274 | 0.00106 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 158 | 0.0833 | 1.905 | 146 | 0.0762 | 1.536 |
| OOS | 12 | 0.3153 | 1.670 | 19 | 0.3321 | 2.899 |
...
- Canonical filter delegation: `filter_signal(..., 'X_MES_ATR70', 'NYSE_CLOSE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-x-mes-atr70-o15-s075-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-x-mes-atr70-o15-s075-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-nyse-close-e2-rr1-0-cb1-x-mes-atr70-o15-s075-chordia-unlock-v1.csv`
