# Chordia strict unlock audit — MNQ_CME_PRECLOSE_E2_RR1.0_CB1_COST_LT10_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-cost-lt10-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-cost-lt10-o15-chordia-unlock-v1.csv`
...
IS clears strict threshold 3.79 with N=996 and ExpR=0.0705; OOS sign matches at N_OOS=64.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1001 | 996 | 99.50% | 755 | 0 | 0.0705 | 0.0701 | 0.1297 | 4.094 | 0.00004 |
...
|---|---:|---:|---:|---:|---:|---:|
| IS | 538 | 0.0938 | 4.117 | 458 | 0.0431 | 1.647 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-cost-lt10-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-cost-lt10-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-cost-lt10-o15-chordia-unlock-v1.csv`
