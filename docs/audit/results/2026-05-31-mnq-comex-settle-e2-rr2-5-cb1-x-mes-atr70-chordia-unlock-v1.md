# Chordia strict unlock audit — MNQ_COMEX_SETTLE_E2_RR2.5_CB1_X_MES_ATR70

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-comex-settle-e2-rr2-5-cb1-x-mes-atr70-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr2-5-cb1-x-mes-atr70-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_COMEX_SETTLE_E2_RR2.5_CB1_X_MES_ATR70`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1494 | 510 | 34.14% | 17 | 0 | 0.1726 | 0.0589 | 0.1118 | 2.525 | 0.01158 |
| OOS | 84 | 46 | 54.76% | 4 | 0 | 0.0467 | 0.0256 | 0.0314 | 0.213 | 0.83155 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 285 | 0.2561 | 2.762 | 225 | 0.0670 | 0.663 |
| OOS | 25 | -0.2805 | -1.141 | 21 | 0.4363 | 1.176 |
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-comex-settle-e2-rr2-5-cb1-x-mes-atr70-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr2-5-cb1-x-mes-atr70-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-comex-settle-e2-rr2-5-cb1-x-mes-atr70-chordia-unlock-v1.csv`
