# Chordia strict unlock audit — MNQ_SINGAPORE_OPEN_E2_RR3.0_CB1_COST_LT10_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-singapore-open-e2-rr3-0-cb1-cost-lt10-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-singapore-open-e2-rr3-0-cb1-cost-lt10-o15-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_SINGAPORE_OPEN_E2_RR3.0_CB1_COST_LT10_O15`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1549 | 916 | 59.13% | 4 | 0 | 0.1643 | 0.0971 | 0.0948 | 2.870 | 0.00411 |
| OOS | 86 | 84 | 97.67% | 0 | 0 | 0.1847 | 0.1804 | 0.1038 | 0.951 | 0.34159 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 494 | 0.2722 | 3.414 | 422 | 0.0379 | 0.464 |
| OOS | 45 | -0.0697 | -0.283 | 39 | 0.4784 | 1.577 |
...
- Canonical filter delegation: `filter_signal(..., 'COST_LT10', 'SINGAPORE_OPEN')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-singapore-open-e2-rr3-0-cb1-cost-lt10-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-singapore-open-e2-rr3-0-cb1-cost-lt10-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-singapore-open-e2-rr3-0-cb1-cost-lt10-o15-chordia-unlock-v1.csv`
