...
**Generated:** 2026-04-19T11:35:09+00:00
...
**Input audit streams:**
  ...
  - Portfolio subset-t + lift-vs-unfiltered sweep (Phase 2.5) (`docs/audit/results/2026-04-19-portfolio-subset-t-sweep.md`)
...
|---|---|---|---:|---:|---|---|---|---|
| 1 | `MNQ_US_DATA_1000_E2_RR1.5_CB1_ORB_G5_O15` | **RETIRE_URGENT** | 800 | +1.34 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-1 with NEGATIVE late Sharpe — actively losing |
| 2 | `MNQ_EUROPE_FLOW_E2_RR1.5_CB1_COST_LT12` | **RETIRE_STANDARD** | 521 | +2.07 | PASS | PASS | Tier 3 (t in [1.96, 2.58)) | RETIREMENT Tier-1: excess decay > 0.60 vs portfolio |
| 3 | `MNQ_EUROPE_FLOW_E2_RR1.5_CB1_CROSS_SGP_MOMENTUM` | **RETIRE_STANDARD** | 535 | +1.70 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-1: excess decay > 0.60 vs portfolio |
| 4 | `MNQ_EUROPE_FLOW_E2_RR2.0_CB1_CROSS_SGP_MOMENTUM` | **RETIRE_STANDARD** | 535 | +1.98 | PASS | PASS | Tier 3 (t in [1.96, 2.58)) | RETIREMENT Tier-1: excess decay > 0.60 vs portfolio |
| 5 | `MES_CME_PRECLOSE_E2_RR1.0_CB1_COST_LT08` | **N_UNDERPOWERED** | 88 | +3.56 | FAIL | PASS | Tier 1 thin-N (t>=3.00, N<100) | C7 FAIL: Mode A N=88 < 100 |
| 6 | `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_COST_LT12` | **RECLASSIFY_COST** | 669 | +2.94 | PASS | PASS | Tier 2 (t in [2.58, 3.00)) | Rule 8.2 arithmetic_only (wr_spread < 3% with material ExpR_delta) |
| 7 | `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_ORB_G5` | **RECLASSIFY_COST** | 836 | +2.50 | PASS | PASS | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 95.1% (>95%) |
| 8 | `MNQ_COMEX_SETTLE_E2_RR1.5_CB1_ORB_G5` | **RECLASSIFY_COST** | 829 | +2.32 | PASS | FAIL | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 95.1% (>95%) |
| 9 | `MNQ_COMEX_SETTLE_E2_RR2.0_CB1_ORB_G5` | **RECLASSIFY_COST** | 814 | +2.24 | PASS | FAIL | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 95.1% (>95%) |
| 10 | `MNQ_EUROPE_FLOW_E2_RR1.0_CB1_COST_LT12` | **RECLASSIFY_COST** | 521 | +1.34 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | Rule 8.2 arithmetic_only (wr_spread < 3% with material ExpR_delta) |
| 11 | `MNQ_NYSE_OPEN_E2_RR1.0_CB1_COST_LT12` | **RECLASSIFY_COST** | 844 | +2.10 | PASS | PASS | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 98.6% (>95%) |
| 12 | `MNQ_NYSE_OPEN_E2_RR1.0_CB1_ORB_G5` | **RECLASSIFY_COST** | 856 | +2.03 | PASS | PASS | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 99.7% (>95%) |
| 13 | `MNQ_NYSE_OPEN_E2_RR1.5_CB1_COST_LT12` | **RECLASSIFY_COST** | 817 | +2.11 | PASS | FAIL | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 98.6% (>95%) |
| 14 | `MNQ_NYSE_OPEN_E2_RR1.5_CB1_ORB_G5` | **RECLASSIFY_COST** | 829 | +2.06 | PASS | FAIL | Tier 3 (t in [1.96, 2.58)) | Rule 8.1 fire-rate 99.7% (>95%) |
| 15 | `MNQ_SINGAPORE_OPEN_E2_RR1.5_CB1_ATR_P50_O15` | **RECLASSIFY_COST** | 496 | +3.96 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | Rule 8.2 arithmetic_only (wr_spread < 3% with material ExpR_delta) |
| 16 | `MNQ_CME_PRECLOSE_E2_RR1.0_CB1_X_MES_ATR60` | **REVIEW_TIER2** | 306 | +4.19 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 17 | `MNQ_EUROPE_FLOW_E2_RR1.0_CB1_CROSS_SGP_MOMENTUM` | **REVIEW_TIER2** | 535 | +1.34 | PASS | FAIL | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 18 | `MNQ_EUROPE_FLOW_E2_RR1.0_CB1_ORB_G5` | **REVIEW_TIER2** | 773 | +1.10 | PASS | FAIL | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 19 | `MNQ_EUROPE_FLOW_E2_RR2.0_CB1_ORB_G5` | **REVIEW_TIER2** | 773 | +1.54 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 20 | `MNQ_TOKYO_OPEN_E2_RR1.0_CB1_COST_LT12` | **REVIEW_TIER2** | 469 | +1.87 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 21 | `MNQ_US_DATA_1000_E2_RR1.0_CB1_VWAP_MID_ALIGNED_O15` | **REVIEW_TIER2** | 460 | +2.99 | PASS | PASS | Tier 2 (t in [2.58, 3.00)) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 22 | `MNQ_US_DATA_1000_E2_RR1.5_CB1_VWAP_MID_ALIGNED_O15` | **REVIEW_TIER2** | 436 | +3.20 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | RETIREMENT Tier-2: excess decay 0.10-0.60 vs portfolio |
| 23 | `MNQ_SINGAPORE_OPEN_E2_RR1.5_CB1_ATR_P50_O30` | **REVIEW_CAPACITY** | 485 | +4.14 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | SGP O15/O30 pair: Jaccard 0.65 — capacity review before parallel deploy |
| 24 | `MNQ_EUROPE_FLOW_E2_RR1.0_CB1_OVNRNG_100` | **REVIEW_C4_WT_FAIL** | 263 | +0.99 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=0.99 < 3.0 |
| 25 | `MNQ_EUROPE_FLOW_E2_RR1.5_CB1_ORB_G5` | **REVIEW_C4_WT_FAIL** | 773 | +1.90 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.90 < 3.0 |
| 26 | `MNQ_EUROPE_FLOW_E2_RR1.5_CB1_OVNRNG_100` | **REVIEW_C4_WT_FAIL** | 263 | +1.65 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.65 < 3.0 |
| 27 | `MNQ_NYSE_OPEN_E2_RR1.0_CB1_X_MES_ATR60` | **REVIEW_C4_WT_FAIL** | 345 | +1.51 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.51 < 3.0 |
| 28 | `MNQ_NYSE_OPEN_E2_RR1.5_CB1_X_MES_ATR60` | **REVIEW_C4_WT_FAIL** | 334 | +1.00 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.00 < 3.0 |
| 29 | `MNQ_TOKYO_OPEN_E2_RR1.5_CB1_COST_LT12` | **REVIEW_C4_WT_FAIL** | 469 | +1.95 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.95 < 3.0 |
| 30 | `MNQ_TOKYO_OPEN_E2_RR1.5_CB1_ORB_G5` | **REVIEW_C4_WT_FAIL** | 786 | +2.50 | PASS | FAIL | Tier 3 (t in [1.96, 2.58)) | C4 with-theory FAIL: t_IS=2.50 < 3.0 |
| 31 | `MNQ_TOKYO_OPEN_E2_RR2.0_CB1_ORB_G5` | **REVIEW_C4_WT_FAIL** | 785 | +2.62 | PASS | PASS | Tier 2 (t in [2.58, 3.00)) | C4 with-theory FAIL: t_IS=2.62 < 3.0 |
| 32 | `MNQ_US_DATA_1000_E2_RR1.0_CB1_X_MES_ATR60` | **REVIEW_C4_WT_FAIL** | 371 | +1.56 | PASS | PASS | Tier 4 (t<1.96 — fails p<0.05) | C4 with-theory FAIL: t_IS=1.56 < 3.0 |
| 33 | `MNQ_US_DATA_1000_E2_RR2.0_CB1_VWAP_MID_ALIGNED_O15` | **REVIEW_C4_WT_FAIL** | 398 | +2.09 | PASS | PASS | Rule 8.3 ARITHMETIC_LIFT (retire/reframe) | C4 with-theory FAIL: t_IS=2.09 < 3.0 |
| 34 | `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_OVNRNG_100` | **BETTER_THAN_PEERS** | 283 | +3.42 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | Regime-stress BETTER-THAN-PEERS: Sharpe rose early→late |
| 35 | `MNQ_COMEX_SETTLE_E2_RR1.5_CB1_OVNRNG_100` | **BETTER_THAN_PEERS** | 278 | +2.65 | PASS | PASS | Rule 8.3 ARITHMETIC_LIFT (retire/reframe) | Regime-stress BETTER-THAN-PEERS: Sharpe rose early→late |
| 36 | `MNQ_COMEX_SETTLE_E2_RR1.5_CB1_X_MES_ATR60` | **BETTER_THAN_PEERS** | 379 | +3.32 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | Regime-stress BETTER-THAN-PEERS: Sharpe rose early→late |
| 37 | `MES_CME_PRECLOSE_E2_RR1.0_CB1_ORB_G8` | **KEEP** | 130 | +3.66 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | — |
| 38 | `MNQ_COMEX_SETTLE_E2_RR1.0_CB1_X_MES_ATR60` | **KEEP** | 385 | +4.29 | PASS | PASS | Tier 1 (t>=3.00 Chordia PASS) | Fire-rate audit reported 0% — artifact of missing CrossAssetATR injection in that audit's scope, NOT a lane defect. Criterion eval applies canonical injection and the lane has real data. |
...
- Phase 2.5 subset-t sweep: Tier 4 (t<1.96 — fails p<0.05)
- Years positive: 6/7
- Evidence:
...
- Phase 2.5 subset-t sweep: Tier 3 (t in [1.96, 2.58))
- Years positive: 7/7
- Evidence:
...
- Phase 2.5 subset-t sweep: Tier 1 thin-N (t>=3.00, N<100)
- Years positive: 3/3
- Evidence:
...
- Phase 2.5 subset-t sweep: Tier 2 (t in [2.58, 3.00))
- Years positive: 6/7
- Evidence:
...
- Phase 2.5 subset-t sweep: Tier 1 (t>=3.00 Chordia PASS)
- Years positive: 6/7
- Evidence:
  - Rule 8.2 arithmetic_only (wr_spread < 3% with material ExpR_delta)
  - Mode-B grandfathered: stored ExpR last_trade_day=2026-04-06 >= 2026-01-01; stored values are not Mode-A-clean.
...
- Phase 2.5 subset-t sweep: Rule 8.3 ARITHMETIC_LIFT (retire/reframe)
- Years positive: 5/7
- Evidence:
