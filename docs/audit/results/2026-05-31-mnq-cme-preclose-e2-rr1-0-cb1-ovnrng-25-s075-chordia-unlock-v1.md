...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1479 | 1458 | 98.58% | 121 | 0 | 0.0956 | 0.0943 | 0.1234 | 4.712 | 0.00000 |
...
|---|---:|---:|---:|---:|---:|---:|
| IS | 739 | 0.1161 | 4.066 | 719 | 0.0746 | 2.586 |
...
- Canonical filter delegation: `filter_signal(..., 'OVNRNG_25', 'CME_PRECLOSE')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-ovnrng-25-s075-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-ovnrng-25-s075-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-cme-preclose-e2-rr1-0-cb1-ovnrng-25-s075-chordia-unlock-v1.csv`
