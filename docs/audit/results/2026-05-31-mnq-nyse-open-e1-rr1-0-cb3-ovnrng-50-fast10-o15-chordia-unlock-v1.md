# Chordia strict unlock audit — MNQ_NYSE_OPEN_E1_RR1.0_CB3_OVNRNG_50_FAST10_O15

**Prereq file:** `docs\audit\hypotheses\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-ovnrng-50-fast10-o15-chordia-unlock-v1.yaml`
**Result CSV:** `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-ovnrng-50-fast10-o15-chordia-unlock-v1.csv`
**Canonical DB:** `C:\Users\joshd\canompx3\gold.db`

## Scope

Strict-Chordia unlock audit for the exact lane `MNQ_NYSE_OPEN_E1_RR1.0_CB3_OVNRNG_50_FAST10_O15`. Tests whether the bounded canonical replay clears Chordia's strict t-stat hurdle (3.79, has_theory=False) on canonical IS data, with descriptive OOS sign-match as a secondary gate. Single-lane K=1 confirmatory replay; no parameter sweeps, no filter variants, no instrument extensions.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| IS | 1545 | 828 | 53.59% | 113 | 49 | 0.0744 | 0.0399 | 0.0834 | 2.401 | 0.01636 |
| OOS | 86 | 60 | 69.77% | 15 | 3 | 0.0998 | 0.0696 | 0.1186 | 0.918 | 0.35842 |

## Directional breakdown

| Split | Long N | Long ExpR | Long t | Short N | Short ExpR | Short t |
|---|---:|---:|---:|---:|---:|---:|
| IS | 408 | 0.1214 | 2.689 | 420 | 0.0287 | 0.676 |
| OOS | 33 | 0.0366 | 0.246 | 27 | 0.1771 | 1.102 |
...
- Canonical filter delegation: `filter_signal(..., 'OVNRNG_50_FAST10', 'NYSE_OPEN')`.
...
```
python research/chordia_strict_unlock_v1.py --hypothesis-file docs\audit\hypotheses\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-ovnrng-50-fast10-o15-chordia-unlock-v1.yaml
```

Outputs (overwritten in place):

- `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-ovnrng-50-fast10-o15-chordia-unlock-v1.md`
- `docs\audit\results\2026-05-31-mnq-nyse-open-e1-rr1-0-cb3-ovnrng-50-fast10-o15-chordia-unlock-v1.csv`
