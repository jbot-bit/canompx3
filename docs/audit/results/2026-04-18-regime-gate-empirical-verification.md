...
| code | count | meaning |
|---|---:|---|
| AGREE_SIGN | 23 | UNFILT and FILT_POOLED agree on sign — deployment verdict unchanged |
| SIGN_FLIP | 0 | UNFILT and FILT_POOLED disagree on sign — deployment verdict flips under patch |
| FILT_EMPTY | 7 | filter fires on 0 trades in window — FILT regime undefined |
| FILT_UNKNOWN | 0 | filter_type not in ALL_FILTERS |
| UNFILT_EMPTY | 0 | no pooled data in window |

## Bug materiality verdict

**BUG_LATENT** — 0 sign flips on current window, but 7 lane(s) have FILT_EMPTY (filter fires on 0 trades in the 6mo window). Patch behavior is undefined for these lanes and needs a policy (e.g., fall back to UNFILT vs block deployment). A2b-1 scope must specify.
...
| `MNQ_COMEX_SETTLE_E2_RR1.0_CB` | MNQ | COMEX_SETTLE | E2/1.0/1/5 | `COST_LT12` | `+0.0418` | `null` (0) | `null` (0) | `FILT_EMPTY` |
...
| `MNQ_EUROPE_FLOW_E2_RR1.5_CB1` | MNQ | EUROPE_FLOW | E2/1.5/1/5 | `COST_LT12` | `+0.1534` | `null` (0) | `null` (0) | `FILT_EMPTY` |
...
| `MNQ_EUROPE_FLOW_E2_RR1.0_CB1` | MNQ | EUROPE_FLOW | E2/1.0/1/5 | `COST_LT12` | `+0.1534` | `null` (0) | `null` (0) | `FILT_EMPTY` |
| `MNQ_NYSE_OPEN_E2_RR1.5_CB1_C` | MNQ | NYSE_OPEN | E2/1.5/1/5 | `COST_LT12` | `+0.1071` | `null` (0) | `null` (0) | `FILT_EMPTY` |
...
| `MNQ_NYSE_OPEN_E2_RR1.0_CB1_C` | MNQ | NYSE_OPEN | E2/1.0/1/5 | `COST_LT12` | `+0.1071` | `null` (0) | `null` (0) | `FILT_EMPTY` |
...
| `MNQ_TOKYO_OPEN_E2_RR1.0_CB1_` | MNQ | TOKYO_OPEN | E2/1.0/1/5 | `COST_LT12` | `+0.0897` | `null` (0) | `null` (0) | `FILT_EMPTY` |
| `MNQ_TOKYO_OPEN_E2_RR1.5_CB1_` | MNQ | TOKYO_OPEN | E2/1.5/1/5 | `COST_LT12` | `+0.0897` | `null` (0) | `null` (0) | `FILT_EMPTY` |
