...
|-----:|------|-------------|-----------:|---------:|----------------|-------------------|------------------|---------------------|--------|
| 1 | 2026-05-19 | MNQ_US_DATA_1000_E1_RR1.0_CB2_PD_CLEAR_LONG_O30 | 0.250 | 3.064 | NA_N_BELOW_FLOOR | docs/audit/hypotheses/drafts/2026-05-19-mnq-us-data-1000-e1-rr1-0-cb2-pd-clear-long-o30-chordia-heavyweight-v1.draft.yaml | — | DEFERRED_NOT_RUN | OOS underpowered (N=14, IS+0.17 / OOS-0.02 sign-flip, dir_match=N); deflation_headroom=0 since pooled_t=3.06 < strict 3.79; draft authored for record but NOT promoted to active hypotheses/. **CORRECTED (2026-05-19, FAST_LANE OOS-power gate landed):** original "wait for OOS N to accrue past 30" was a category error per [[oos-does-not-accrue-holdout-is-frozen]] — sacred holdout doesn't grow on calendar wait without violating RULE 3. Pre-flight OOS-power gate (Check #161) now classifies this entry as `REJECTED_OOS_UNPOWERED` at scanner classification time: expected_n_oos=20 (fire_rate=0.1468 × oos_window_days=136) → expected_power=0.247 < floor=0.50 at cohen_d=0.3. Cell is structurally unbuildable. Legitimate next-step paths per RULE 3.3: CPCV (LdP 2018 § 12.4), Harvey-Liu haircut, pool with correlated siblings, or PARK. Default verdict: **PARK** unless operator explicitly authorizes one of the three rescue paths. Next cherry-pick iteration trigger: new fast-lane PROMOTE landing — NOT this entry. |
