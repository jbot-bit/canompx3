...
- `cost-realism-slippage-pilot` — Book-wide cost-realism debt. **MNQ portion FULLY CLOSED 2026-04-20:**
   ...
   - Both MGC + MNQ: median = 0 ticks routine. Honest central tendency is modeled-conservative.
   - STILL OPEN: (a) MES TBBO pilot NOT run — book-wide MES deployed-lane ExpR carries unmeasured friction optimism; (b) event-day tail NOT measured for MNQ (2021-2026 sample had no MGC-2018-type gap — known-unknown, not refuted concern).
