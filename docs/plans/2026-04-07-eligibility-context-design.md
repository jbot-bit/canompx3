...
| 2 | Trade sheet integration (View A) | `scripts/tools/generate_trade_sheet.py` | **COMPLETE 2026-04-07** — see [`2026-04-07-trade-book-canonicalization-design.md`](./2026-04-07-trade-book-canonicalization-design.md). View B (filter universe audit page) deferred to a future stage. |
