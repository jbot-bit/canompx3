...
def _make_row(**overrides):
    ...
    base = {
        "strategy_id": "MGC_0900_RR2.0_CB1_NO_FILTER",
        "instrument": "MGC",
        "orb_label": "0900",
        "orb_minutes": 5,
        "rr_target": 2.0,
        ...
        "avg_win_r": 1.8,
        "avg_loss_r": 1.0,
        "expectancy_r": 0.54,  # 0.55*1.8 - 0.45*1.0
        "sharpe_ratio": 0.3,
        "max_drawdown_r": 5.0,
...
class TestValidateStrategy:
    ...
    def test_reject_stress_test(self):
        ...
        # Very low ExpR that can't absorb stress costs
        status, notes = validate_strategy(
    ...
    def test_optional_phases_skipped_by_default(self):
        ...
        # Low sharpe, high DD — should still pass
        status, notes = validate_strategy(
