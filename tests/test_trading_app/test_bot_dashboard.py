...
def test_run_preflight_subprocess_preserves_warn_status_on_strict_returncode(monkeypatch):
    """Strict-zero-warn returns rc=1 for advisory-only live preflight, but
    dashboard status should remain WARN (not FAIL) so the UI explains the
    live blocker accurately.
    """
