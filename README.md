...
Self-contained data pipeline and backtesting engine for Opening Range Breakout (ORB) strategies on micro futures (MGC, MNQ, MES, M2K). 10 years of 1-minute bar data, 1,251 validated strategies across 5/15/30m ORB apertures, 35 drift checks, fully automated guardrails.
...
python pipeline/check_drift.py                     # 19 static analysis checks
...
2. **19 drift checks** -- architecture isolation, config sync, timezone hygiene
