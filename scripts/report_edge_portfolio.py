...
Usage:
    python scripts/report_edge_portfolio.py --instrument MGC
    python scripts/report_edge_portfolio.py --all
    python scripts/report_edge_portfolio.py --all --db-path C:/db/gold.db
    python scripts/report_edge_portfolio.py --all --include-purged
"""
