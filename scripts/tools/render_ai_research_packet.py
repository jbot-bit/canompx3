#!/usr/bin/env python3
"""Render a canonical AI research packet for OpenRouter workflows."""
...
from trading_app.ai.research_packet import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Render a canonical AI research packet.")
    ...
    parser.add_argument("--format", default="json", choices=["json", "markdown", "openrouter-request"])
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "markdown":
        ...
        return 0
    if args.format == "openrouter-request":
        print(json.dumps(build_openrouter_request(packet), indent=2, sort_keys=True))
        return 0
