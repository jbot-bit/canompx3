...
# benjamini_hochberg relocated to trading_app.dsr (multiple-testing-correction
# leaf) to break the strategy_validator <-> strategy_discovery import cycle.
# Re-exported below so existing `from trading_app.strategy_validator import
# benjamini_hochberg` call sites keep working.
from trading_app.dsr import benjamini_hochberg  # noqa: E402
