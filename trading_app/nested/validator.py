"""
Validate nested ORB strategies and promote to nested_validated.

Same validation logic as strategy_validator.py but reads/writes nested tables.

Usage:
    python -m trading_app.nested.validator --instrument MGC
...
def run_nested_validation(
    ...
    """Validate all nested_strategies and promote passing ones.
