...
# Relocated here from strategy_validator.py to break the
# strategy_validator <-> strategy_discovery import cycle. dsr.py is the
# multiple-testing-correction leaf (pure math, no project imports), so both
# the validator and the discovery scan can import this from a common leaf.
# =========================================================================
