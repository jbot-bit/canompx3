...
class TradovateOrderRouter(BrokerRouter):
    ...
    def submit(self, spec: dict) -> dict:
        ...
        # Price collar — ENTRY stop only. Bracket targets are expected far from market (RR2.5 = ~1%).
        # Matches ProjectX behavior: only collar the entry stopPrice, not bracket target/stop.
